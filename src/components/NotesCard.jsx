...
export const NotesCard = ({ podcast, user, setSignInOpen }) => {
  ...
  return (
    <Card to={`/notes/${podcast._id}`}>
        ...
        <CardInformation>
          <MainInfo>
            ...
            <CreatorInfo>
              ...
              {/* Display Main Rank and Advance Rank in column layout */}
              <div
                style={{ display: "flex", flexDirection: "column", gap: "4px" }}
              >
                <Views>• Mains Rank: {podcast.views}</Views>
                <Views>• Advanced Rank: {podcast.views}</Views>
              </div>
            </CreatorInfo>
          </MainInfo>
        </CardInformation>
      ...
      <PlayIcon>
        {podcast?.type === "video" ? (
          <LocalMallIcon style={{ width: "28px", height: "28px" }} />
        ) : (
          <LocalMallIcon style={{ width: "28px", height: "28px" }} />
        )}
      </PlayIcon>
