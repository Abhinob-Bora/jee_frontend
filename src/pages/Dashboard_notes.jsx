...
const DashboardNotes = ({ setSignInOpen }) => {
      ...
      {loading ? (
        ...
        <>
          ...
          <FilterContainer>
            <Topic>
              Comedy
              <Link to={`/shownotes/comedy`} style={{ textDecoration: "none" }}>
                <Span>Show All</Span>
              </Link>
            </Topic>
            <Podcasts>
          ...
          <FilterContainer>
            <Link to={`/shownotes/news`} style={{ textDecoration: "none" }}>
              <Topic>
                News
                <Span>Show All</Span>
              </Topic>
          ...
          <FilterContainer>
            <Link to={`/shownotes/crime`} style={{ textDecoration: "none" }}>
              <Topic>
                Crime
                <Span>Show All</Span>
              </Topic>
          ...
          <FilterContainer>
            <Link to={`/shownotes/sports`} style={{ textDecoration: "none" }}>
              <Topic>
                Sports
                <Span>Show All</Span>
              </Topic>
