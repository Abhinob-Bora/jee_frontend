    ...
    <Box sx={{ width: "100%" }}>
      ...
      >
        <Stack sx={{ height: "100%" }} justifyContent="center">
          ...
          >
            Learn under the guidance of an IITian!
          </Title>

          <Typography variant="h6" sx={{ mb: 4 }}>
            India's first real-time mentorship platform
          </Typography>

          <Typography variant="body1" sx={{ mb: 4 }}>
            Book video sessions now and prepare with personalized mentorship from IITians, specially designed for future IITians.
          </Typography>
